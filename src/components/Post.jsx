...
export default async function Post(params) {
  const result = await db.query(`
    ...
    where posts.id = $1`,[params.id]);

  console.log(params.id);
  let img_url = "https://qyjseqevsbahrjdnvkny.supabase.co/storage/v1/object/public/images/default.jpg?t=2024-09-16T13%3A13%3A17.184Z"
  ...
  return (
    <div className="postBody">
      ...
      { // If content exists, display content & image/video. Else, display error.
        ...
        (post_vid != null && post_vid != "")||(post_img != null && post_img != "")
        ? <div className="postMediaContainer">

          {// If image exists and video does not, load image. Nothing is rendered otherwise.
            (post_img != null && post_img != "" && (post_vid == null || post_vid == ""))
            ? <Image src={post_img} alt={params.content} width={0} height={0} sizes="100vw" style={{ width: '100%', height: 'auto' }}></Image>
            : null
          }
